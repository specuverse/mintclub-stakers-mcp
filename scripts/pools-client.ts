// skills/mintclub/scripts/mintclub-pools-client.ts
// MintClub Pools client — ERC-8128 auth + x402 micropaiement
// Lists all MintClub staking pools on Base (V1 + V2)
